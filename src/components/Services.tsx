    ...
    >
      ...
      {showText && (
        <motion.p
          ...
          className="absolute text-2xl md:text-5xl font-bold text-primary font-sans leading-tight"
        >
          {servicesTitle}
        </motion.p>
      )}
      ...
      xl:scale-135 xl:translate-x-28"
        ...
        <div className="w-full md:w-1/2 max-w-xl px-4 py-6">
          ...
          <p className="mt-2 text-base md:text-lg text-primary">{subTitle1}</p>
          <br />
          <h2 className="text-xl md:text-3xl font-bold text-primary">
            {maintTitle2}
          </h2>
          <p className="mt-2 text-base md:text-lg text-primary">{subTitle2}</p>
          <br />
          <h2 className="text-xl md:text-3xl font-bold text-primary">
            {maintTitle3}
          </h2>
          <p className="mt-2 text-base md:text-lg text-primary">{subTitle3}</p>
        </div>
      </div>
    </div>
  );
